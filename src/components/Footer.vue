    ...
    <div class="footer">
        <div>
            <a
                ...
                @click="currentPage === page.Control ? (currentPage = page.Statistics) : (currentPage = page.Control)"
            >
                <svg v-if="currentPage === page.Control" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <a href="#" class="settings-button" @click="currentPage = page.Settings">
...
const { user, currentPage, page } = storeToRefs(useMainStore())
</script>
<style scoped>
.footer {
    height:50px;
